...
1. **Threat Hunter** scans sources across the agentic AI security landscape, discovers incidents, classifies against OWASP Agentic Top 10, NIST AI RMF and CIS Controls, scores severity, links CVEs, assigns VTMS identifiers
...
| [`vectimus/vectimus-website`](https://github.com/vectimus/vectimus-website) | Blog posts, incident briefs | Threat Analyst opens PRs |
